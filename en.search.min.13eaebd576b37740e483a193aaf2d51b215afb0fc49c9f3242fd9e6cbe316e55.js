...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cb8af31beaf613c0bee5c5ca00cd19ea3fdd06f230ef5017a64c4a9954589ae3.js',function(){input.required=false;search();});}
