...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.07852127d2e2cec0e41c5355eb14df9ee1be1de7ebab164066f0cb29df28cb86.js',function(){input.required=false;search();});}
