...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7310b4327816026f5d1d7940eff5e63ad896ff286112170e3f6e36131e5c4079.js',function(){input.required=false;search();});}
