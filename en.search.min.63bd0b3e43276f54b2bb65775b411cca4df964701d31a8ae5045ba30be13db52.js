...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e12f4a7f2947d6b814d04857d0ec507d59a3a6189a769cdef2b0aa2209697f39.js',function(){input.required=false;search();});}
