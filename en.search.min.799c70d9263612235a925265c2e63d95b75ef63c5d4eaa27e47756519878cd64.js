...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6cff808cad8b8ae524d24425971c5e64fbba813c24c988c96b53ea65a92c0d1f.js',function(){input.required=false;search();});}
