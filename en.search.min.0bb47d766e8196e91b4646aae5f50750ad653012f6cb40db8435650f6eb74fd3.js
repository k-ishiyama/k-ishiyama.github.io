...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bf83913853f916efe4334bc532c817a279cb91e1473abfcc6bfb7328940f12db.js',function(){input.required=false;search();});}
